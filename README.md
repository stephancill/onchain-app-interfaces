...
- a hybrid [Avantis v2 trading adapter](docs/adapters/avantis.md) with typed positions and strictly validated open, close, order, margin, and delegation actions.
