...
const moonwellUsdcMarket = "0xEdc817A28E8B93B03976FBd4a3dDBc9f7D176c22";
const examples = [
  {
    name: "Aerodrome",
    chainId: "8453",
...
function defaultValues(
  ...
  if (descriptor.name === "aerodrome.pool") {
    return jsonValue({
  ...
  if (descriptor.name === "moonwell.position") {
    return jsonValue({
      account: account ?? "0x0000000000000000000000000000000000000000",
      market: moonwellUsdcMarket,
    });
  }
  if (descriptor.name === "moonwell.market") {
    return jsonValue({
      underlying: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913",
    });
  }
  if (descriptor.name === "moonwell.supply") {
    return jsonValue({
      parameters: {
        market: moonwellUsdcMarket,
        amount: "1000000",
